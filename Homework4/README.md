```shell
 disbro@Dis-Bro  ~  cd /etc/apt/sources.list.d/
 disbro@Dis-Bro  sources.list.d  ll
total 44
...
-rw-r--r-- 1 root root  203 дек  9 22:13 vscode.list
 disbro@Dis-Bro  sources.list.d  sudo su
Welcome to fish, the friendly interactive shell
Type help for instructions on how to use fish
root@Dis-Bro /e/a/sources.list.d#
root@Dis-Bro /e/a/sources.list.d#
root@Dis-Bro /e/a/sources.list.d#
root@Dis-Bro /e/a/sources.list.d# cat > nginx.list
deb https://nginx.org/packages/ubuntu/ focal nginx
deb-src https://nginx.org/packages/ubuntu/ focal nginx⏎
root@Dis-Bro /e/a/sources.list.d# cat nginx.list
deb https://nginx.org/packages/ubuntu/ focal nginx
deb-src https://nginx.org/packages/ubuntu/ focal nginx⏎
root@Dis-Bro /e/a/sources.list.d# # Все добавилось в список
root@Dis-Bro /e/a/sources.list.d# apt update
...
root@Dis-Bro /e/a/sources.list.d# apt install nginx
Чтение списков пакетов… Готово
Построение дерева зависимостей
Чтение информации о состоянии… Готово
...
root@Dis-Bro /e/a/sources.list.d#
root@Dis-Bro /e/a/sources.list.d#
root@Dis-Bro /e/a/sources.list.d# dpkg -P nginx
...
root@Dis-Bro /e/a/sources.list.d#
root@Dis-Bro /e/a/sources.list.d#
root@Dis-Bro /e/a/sources.list.d# snap install fromscratch
...
root@Dis-Bro /e/a/sources.list.d [1]# systemctl status snapd.service
System has not been booted with systemd as init system (PID 1). Can`t operate.
Failed to connect to bus: Host is down
root@Dis-Bro /e/a/sources.list.d [1]# # Так как у меня WSL надо подправить конфиги, чтобы она запускалась с systemd
root@Dis-Bro /e/a/sources.list.d [1]# ~
root@Dis-Bro ~# vim /etc/wsl.conf
root@Dis-Bro ~# exit
 disbro@Dis-Bro  root  exit
  ~  wsl --shutdown
  ~  wsl

 disbro@Dis-Bro  fraps 
 disbro@Dis-Bro  fraps  systemctl list-unit-files --type=service
...
235 unit files listed.
 ...
 disbro@Dis-Bro  fraps 
 disbro@Dis-Bro  fraps 
 disbro@Dis-Bro  fraps  # Теперь все хорошо, и можно пользоваться snap
 disbro@Dis-Bro  fraps  sudo snap install fromscratch
[sudo] password for disbro:
fromscratch 1.4.3 from Kilian Valkhof (kilian) installed
 disbro@Dis-Bro  fraps  ~
 disbro@Dis-Bro  ~  cd main
 disbro@Dis-Bro  main  vi test.txt
 disbro@Dis-Bro  main  crontab -e
no crontab for disbro - using an empty one
crontab: installing new crontab
 disbro@Dis-Bro  main  # Добавил новую строку
 disbro@Dis-Bro  main  # */10 * * * * cp /home/disbro/main/test.txt /home/disbro/main/test.txt.bak
 disbro@Dis-Bro  main  crontab -l
...
*/10 * * * * cp /home/disbro/main/test.txt /home/disbro/main/test.txt.bak
 disbro@Dis-Bro  main 
 disbro@Dis-Bro  main 
 disbro@Dis-Bro  main 
 disbro@Dis-Bro  main  ll
total 12
drwxr-xr-x  2 disbro www-data 4096 апр 10 18:37 ./
drwxr-xr-x 15 disbro disbro   4096 апр 10 18:14 ../
...
-rw-r--r--  1 disbro disbro     22 апр 10 18:37 test.txt
 disbro@Dis-Bro  main  # Время 18:44
 disbro@Dis-Bro  main  ll
total 16
drwxr-xr-x  2 disbro www-data 4096 апр 10 18:50 ./
drwxr-xr-x 15 disbro disbro   4096 апр 10 18:14 ../
-rw-rw-r--  1 disbro www-data    0 апр  5 17:57 file1
-rw-------  1 disbro www-data    0 апр  5 17:57 file2
-rw-r--r--  1 disbro disbro     22 апр 10 18:37 test.txt
-rw-r--r--  1 disbro disbro     22 апр 10 18:50 test.txt.bak
 disbro@Dis-Bro  main  # Время 18:56
```